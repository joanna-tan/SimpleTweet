...
public class TwitterClient extends OAuthBaseClient {
	...
	//instruct twitter to open client again
	...
	public void getHomeTimeline(JsonHttpResponseHandler handler) {
		...
		params.put("count", 25);
		// since_id returns results with an ID greater than 2nd param (more recent)
	...
	public void replyTweet(long id, String tweetContent, JsonHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/update.json");
		// Can specify query string params directly or through RequestParams.
		RequestParams params = new RequestParams();
		params.put("status", tweetContent);
		params.put("in_reply_to_status_id", id);
		// make all tweets(POST/GET) extended to follow params
		params.put("tweet_mode", "extended");
		client.post(apiUrl, params, "", handler);
	}
